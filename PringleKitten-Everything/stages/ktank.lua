...
function onCreate()
	...
	makeLuaSprite('tankSky', 'k7week/tankSky', -400, -400);
	setScrollFactor('tankSky', 0, 0);

	makeLuaSprite('tankBuildings', 'k7week/tankBuildings', -200, 0);
	setScrollFactor('tankBuildings', 0.3, 0.3);
	scaleObject('tankBuildings', 1.1, 1.1);

	makeLuaSprite('tankRuins', 'k7week/tankRuins', -200, 0);
	setScrollFactor('tankRuins', 0.35, 0.35);
	scaleObject('tankRuins', 1.1, 1.1);

	makeAnimatedLuaSprite('tankWatchtower', 'k7week/tankWatchtower', 100, 50);
	addAnimationByPrefix('tankWatchtower', 'idle', 'watchtower', 24, false);
	setScrollFactor('tankWatchtower', 0.5, 0.5);

	makeAnimatedLuaSprite('tankRolling', 'k7week/tankRolling', 300, 300);
	addAnimationByPrefix('tankRolling', 'idle', 'BG tank w lighting', 24, true);
	setScrollFactor('tankRolling', 0.5, 0.5);

	makeLuaSprite('tankGround', 'k7week/tankGround', -420, -150);
	scaleObject('tankGround', 1.15, 1.15);
	
-- low quality
	if not lowQuality then
		makeLuaSprite('tankClouds', 'k7week/tankClouds', getRandomInt(-700, -100), getRandomInt(-20, 20));
		setScrollFactor('tankClouds', 0.1, 0.1);
		setProperty('tankClouds.velocity.x', getRandomInt(5, 15));

		makeLuaSprite('tankMountains', 'k7week/tankMountains', -300, -20);
		setScrollFactor('tankMountains', 0.2, 0.2);
		scaleObject('tankMountains', 1.2, 1.2);

		makeAnimatedLuaSprite('smokeLeft', 'k7week/smokeLeft', -200, -100);
		addAnimationByPrefix('smokeLeft', 'idle', 'SmokeBlurLeft instance');
		setScrollFactor('smokeLeft', 0.4, 0.4);

		makeAnimatedLuaSprite('sr', 'k7week/smokeRight', 1100, -100);
		addAnimationByPrefix('sr', 'idle', 'SmokeRight instance');
		setScrollFactor('sr', 0.4, 0.4);
	end
	...
	-- after
	makeAnimatedLuaSprite('tank0', 'k7week/tank0', -500, 650);
	addAnimationByPrefix('tank0', 'idle', 'fg', 24, false);
	setScrollFactor('tank0', 1.7, 1.5);
	
	makeAnimatedLuaSprite('tank2', 'k7week/tank2', 450, 940);
	addAnimationByPrefix('tank2', 'idle', 'foreground', 24, false);
	setScrollFactor('tank2', 1.5, 1.5);
	
	makeAnimatedLuaSprite('t5', 'k7week/tank5', 1620, 700);
	addAnimationByPrefix('t5', 'idle', 'fg tankhead far right instance', 24, false);
	setScrollFactor('t5', 1.5, 1.5);
	
	if not lowQuality then
		makeAnimatedLuaSprite('tank1', 'k7week/tank1', -300, 750);
		addAnimationByPrefix('tank1', 'idle', 'fg', 24, false);
		setScrollFactor('tank1', 2.0, 0.2);
		
		makeAnimatedLuaSprite('tank4', 'k7week/tank4', 1300, 900);
		addAnimationByPrefix('tank4', 'idle', 'fg', 24, false);
		setScrollFactor('tank4', 1.5, 1.5);
		
		makeAnimatedLuaSprite('tank3', 'k7week/tank3', 1300, 1200);
...
function onBeatHit()
    if curBeat % 2 == 0 then
	    ...
	    objectPlayAnimation('t5', 'idle', true, 0);
    end
end
