...
class FunkinLua {
	...
	public function new(script:String) {
		...
		set('healthDrain', ClientPrefs.healthDrain);
		set('mechanics', ClientPrefs.mechanics);
		set('assetMovement', ClientPrefs.assetMovement);
		set('ratingPenalty', ClientPrefs.ratingPenalty);
		set('hideHud', ClientPrefs.hideHud);
		set('timeBarType', ClientPrefs.timeBarType);
		set('scoreZoom', ClientPrefs.scoreZoom);
		set('cameraZoomOnBeat', ClientPrefs.camZooms);
		set('hudZoomSections', ClientPrefs.camZoomsHud);
		set('bgZoomSections', ClientPrefs.camZoomsBg);
