...
class GeomPoly{
    ...
    public function new(vertices:Dynamic=null){
        ...
        if(vertices!=null){
            {
                if(#if flash untyped __is__(vertices,Array)#else (vertices is Array)#end){
                ...
                else if(#if flash untyped __is__(vertices,Vec2List)#else (vertices is Vec2List)#end){
                ...
                else if(#if flash untyped __is__(vertices,GeomPoly)#else (vertices is GeomPoly)#end){
