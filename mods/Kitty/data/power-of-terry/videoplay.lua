...
function onCreate()
    ...
    makeLuaText("ret", ("Video Quality: "..vde..'p'), screenWidth/2.5, 0.0, 0.0)
    makeLuaText("ret1", "Press 1-6 to choose Quality.", screenWidth/2.3, 0.0, screenHeight/1.75)
    makeLuaText("ret2", "Press Spacebar to Confirm", screenWidth/2.5, 0.0, screenHeight/2.5)
    makeLuaText("why", "Laggy? Press N for no video.", screenWidth/2.5, 0.0, screenHeight/5)
