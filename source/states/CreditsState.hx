...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			["They are a very toxic and","nothing","","",""],
			["shitty degenerate community.","nothing","","",""],
			["Check out the","nothing","","",""],
			["Friday Night Moddin'","nothing","","",""],
			["Community Server instead.","nothing","","",""],
			["They're better.","nothing","","",""],
			["FNM Community Server", "discord", "", "https://discord.gg/upGMmRYYyx", "0000FF"],
			[""],
			["Funkin' Crew"],
