...
class DiscordClient
{
	...
	private static var _defaultID:String = "1074226637291393075";
	...
	private static var _options:Dynamic = {
		...
		state: null,
		largeImageKey: 'icon',
		largeImageText: "PringleCat Engine",
		smallImageKey : null,
		startTimestamp : null,
		endTimestamp : null
	};
	...
	public static function changePresence(details:String, state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		_options.largeImageText = "Engine Version: " + states.MainMenuState.funnyCatEngineVersion;
