...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var check_ghostTapping = new FlxUICheckBox(10, 45, null, null, "Ghost Tapping", 100);
		check_ghostTapping.checked = _song.ghostTapping;
		check_ghostTapping.callback = function()
			{
				_song.ghostTapping = check_ghostTapping.checked;
				//trace('CHECKED!');
			};
		...
		var stepperBPM:FlxUINumericStepper = new FlxUINumericStepper(120, 110, 1, 1, 1, 400, 3);
		stepperBPM.value = Conductor.bpm;
		stepperBPM.name = 'song_bpm';
		blockPressWhileTypingOnStepper.push(stepperBPM);

		var stepperSpeed:FlxUINumericStepper = new FlxUINumericStepper(120, stepperBPM.y + 25, 0.1, 1, 0.1, 10, 1);
		...
		var gfVersionDropDown = new FlxUIDropDownMenuCustom(player1DropDown.x, player1DropDown.y + 35, FlxUIDropDownMenuCustom.makeStrIdLabelArray(characters, true), function(character:String)
		{
		...
		var player2DropDown = new FlxUIDropDownMenuCustom(player1DropDown.x, gfVersionDropDown.y + 35, FlxUIDropDownMenuCustom.makeStrIdLabelArray(characters, true), function(character:String)
		{
		...
		tab_group_song.add(check_ghostTapping);
		...
		tab_group_song.add(new FlxText(stepperBPM.x, stepperBPM.y - 13, 0, 'Song BPM:'));
		tab_group_song.add(new FlxText(stepperSpeed.x, stepperSpeed.y - 13, 0, 'Song Speed:'));
