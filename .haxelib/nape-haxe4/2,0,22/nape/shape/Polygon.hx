...
class Polygon extends Shape{
    ...
    public function new(localVerts:Dynamic,material:Material=null,filter:InteractionFilter=null){
        ...
        {
            if(#if flash untyped __is__(localVerts,Array)#else (localVerts is Array)#end){
            ...
            else if(#if flash untyped __is__(localVerts,Vec2List)#else (localVerts is Vec2List)#end){
            ...
            else if(#if flash untyped __is__(localVerts,GeomPoly)#else (localVerts is GeomPoly)#end){
